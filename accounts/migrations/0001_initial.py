# Generated by Django 4.2.27 on 2026-02-05 14:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('super_admin', 'Супер-администратор'), ('user', 'Пользователь')], default='user', max_length=20, verbose_name='Роль')),
