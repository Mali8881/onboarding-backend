...
from .frontend_compat_views import (
    ...
    FrontendInstructionsDetailAPIView,
    FrontendLoginAPIView,
    FrontendLogoutAPIView,
    FrontendMeAPIView,
    FrontendMePasswordAPIView,
...
urlpatterns = [
    ...
    path("auth/me/password/", FrontendMePasswordAPIView.as_view()),
    path("auth/users/", FrontendUsersCollectionAPIView.as_view()),
    # Alias set for clients using /accounts/org/users/* namespace.
    path("accounts/org/users/", FrontendUsersCollectionAPIView.as_view()),
    path("auth/users/<int:user_id>/", FrontendUsersDetailAPIView.as_view()),
    path("accounts/org/users/<int:user_id>/", FrontendUsersDetailAPIView.as_view()),
    path("auth/users/<int:user_id>/toggle_status/", FrontendUsersToggleStatusAPIView.as_view()),
    path("accounts/org/users/<int:user_id>/toggle-status/", FrontendUsersToggleStatusAPIView.as_view()),
    path("auth/users/<int:user_id>/set_role/", FrontendUsersSetRoleAPIView.as_view()),
    path("accounts/org/users/<int:user_id>/set-role/", FrontendUsersSetRoleAPIView.as_view()),
