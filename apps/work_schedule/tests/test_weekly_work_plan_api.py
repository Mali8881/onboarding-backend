...
from apps.work_schedule.models import WeeklyWorkPlan, WeeklyWorkPlanChangeLog, WeeklyWorkPlanDeadlineAlert
from apps.work_schedule.services import notify_admins_about_weekly_plan_deadline_miss
...
class WeeklyWorkPlanApiTests(TestCase):
    ...
    def test_online_above_16_requires_reason(self):
        ...
        self.assertIn("online_reason", response.data.get("errors", {}))
    ...
    def test_weekend_time_limits_are_enforced(self):
        ...
        self.assertEqual(response.status_code, 400)
        self.assertIn("days", response.data.get("errors", {}))
