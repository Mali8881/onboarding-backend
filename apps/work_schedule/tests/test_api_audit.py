...
from apps.work_schedule.models import WorkSchedule, UserWorkSchedule
...
class ChooseScheduleAuditTests(TestCase):
    ...
    @patch("apps.work_schedule.views.WorkScheduleAuditService.log_schedule_selection_invalid_payload")
    ...
    @patch("apps.work_schedule.views.WorkScheduleAuditService.log_schedule_selection_not_found")
    ...
    @patch("apps.work_schedule.views.WorkScheduleAuditService.log_schedule_selected_for_approval")
    ...
    @patch("apps.work_schedule.views.WorkScheduleAuditService.log_schedule_request_decision")
