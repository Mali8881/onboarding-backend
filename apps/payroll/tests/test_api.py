...
class PayrollApiTests(TestCase):
    ...
    def test_hourly_rates_invalid_payload_returns_field_errors(self):
        ...
        self.assertIn("fixed_salary", missing_fixed_salary.data.get("errors", {}))
        ...
        self.assertIn("pay_type", invalid_legacy_pay_type.data.get("errors", {}))
    ...
    def test_payroll_compensation_uses_only_contract_pay_type_values(self):
        ...
        self.assertIn("pay_type", response.data.get("errors", {}))
